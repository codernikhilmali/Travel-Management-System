...
public class Destination extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Triund Mcleodganj");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            ...
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Kashi Vishwanath Temple, Varanasi");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Ooty Hill Station");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Mysore Palace");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            ...
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("Dal Lake");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("Stone Chariot, Hampi");
            l11.add(caption);
            Thread.sleep(2800);
